 ...
 */
public class FaspayPaymentCreditWrapperDev extends FaspayPaymentCreditDev {
    ...
    public static void main(String[] args) {
        ...
        JSONObject o;
        try {
            o = new JSONObject(new ObjectMapper().writeValueAsString(w));
            o.remove("cardno");
            o.remove("CARDNO");
            ...
            FormBody.Builder g =  new FormBody.Builder();
            ...
            while (e.hasNext()) {
                ...
                g.addEncoded(next.toUpperCase(), val.replace(' ', '+'));
            }
            w.generateHtml("//Users/hilmananwarsah/test123.html");
