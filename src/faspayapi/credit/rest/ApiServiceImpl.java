...
import faspayapi.rest.ApiService;
...
public abstract class ApiServiceImpl<T> implements ApiService{
    ...
    private FaspayConfigCredit mFaspayConfig;

    public ApiServiceImpl(FaspayConfigCredit mFaspayConfig) {
        mClient = new OkHttpClient.Builder().build();
        this.mFaspayConfig = mFaspayConfig;

    }

    public FaspayConfigCredit getFaspayConfig() {
        return mFaspayConfig;
    }
    private static final Logger LOG = Logger.getLogger(faspayapi.rest.ApiServiceImpl.class.getName());
    ...
    protected T toEntity(String src, Class<T> x) {
        try {
            ...
            Logger.getLogger(faspayapi.rest.ApiServiceImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
