 ...
 */
package faspayapi.debit.entity.cancel;
...
public class FaspayCancelPaymentRequestWrapper extends FaspayCancelPaymentRequest{
    ...
    public FaspayCancelPaymentRequestWrapper(String trxId,  String billNo, String paymentCancel,FaspayConfigDebit mFaspayConfig) {
        this.trxId = trxId;
        this.billNo = billNo;
        this.paymentCancel = paymentCancel;
        this.merchant = mFaspayConfig.getFaspayUser().getMerchantName();
        this.merchantId = mFaspayConfig.getFaspayUser().getMerchantId();
    ...
    public FaspayCancelPaymentRequestWrapper(FaspayPaymentResponse mFaspayPaymentResponse,FaspayConfigDebit mFaspayConfig,String desc) {
        setTrxId(mFaspayPaymentResponse.getTrxId());
        setBillNo(mFaspayPaymentResponse.getBillNo());
        setMerchant(mFaspayPaymentResponse.getMerchant());
