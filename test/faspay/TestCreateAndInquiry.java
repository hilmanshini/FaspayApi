 ...
 */
public class TestCreateAndInquiry {

    public TestCreateAndInquiry() {
    }
    ...
    public void hello() {
        ...
        mFaspayPaymentChannel.setPg_name("Permata");
        //ADD MOCK ITEMS
        ...
        try {
            ...
            Logger.getLogger(TestCreateAndInquiry.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
